...
# CRAN packages
install.packages(
  c("tidyverse", "bookdown", "broom", "car", "data.table", "deming", "devtools", "DiagrammeR", "DT", "ezsummary", "fastmatch", "formatR", "geepack", "ggpmisc", "ggridges", "ggthemes", "grid", "gridExtra", "gtools", "haven", "highcharter", "Hmisc", "htmltools", "httr", "irr", "jsonlite", "kable", "kableExtra", "keras", "knitr", "lattice", "leaflet", "MASS", "magrittr", "mailR", "miniUI", "nlme", "pander", "pkgcopier", "plotly", "purrr", "psych", "quantmod", "rcrossref", "REDCapR", "rmarkdown", "roxygen2", "rpart", "rticles", "sas7bdat", "scatterD3", "shiny", "shinydashboard", "shinyjs", "shinythemes", "sparklyr", "stringi", "survival", "testthat", "timevis", "viridis", "xgboost", "xml2" ),
